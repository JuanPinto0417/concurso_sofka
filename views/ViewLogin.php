    ...
    <div class="container-fluid">
        ...
        <main class="row  d-flex justify-content-center d-flex  align-items-center">
            <form action="../controller/ControllerLogin.php" method="post"
                ...
                <label class="h2" for="">Ingresa tus datos</label>
                <?php
                ...
                <button class="animation-top btn btn-primary mt-1" name="login" type="submit">Entrar</button>
                <button class="animation-top btn btn-danger mt-1" type="reset"> <i class="fas fa-trash"></i></button>

                <div class="row mt-3">
                    <div class="col-md-12 text-right">
                        <a class="size-text" href="ControllerRegister.php">Registrarme</a>
                    </div>
                </div>
            </form>
        </main>
